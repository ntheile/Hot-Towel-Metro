...
This is the port of Hot Towel Mobile ( http://hottowelmobile.azurewebsites.net/ ) to a windows store app.



Hot Towel is a Single Page Application (SPA) boilerplate framework built off Hot Towel that allows you to maintain one 
